...
## this is anto data, the whole size is 1476    
def loaddata():
    ...
    if len(I) == len(Sec_I):
        ...
        for sec_order in xrange(len(Sec_I)):
            ...
            train_set_x[sec_pos[sec_order],sec_din1_index]=sec_din2_index
...
#    train_set_y_adver = train_set_y[1000:2046]
    ...
    n_test_start=000
    n_test_length=1046
    n_test_tile=(n_test_start+n_test_length)/set_x_adver.shape[0]+1
    Set_x_adver=np.tile(set_x_adver,(n_test_tile,1))
    Set_y_adver=np.tile(set_y_adver,n_test_tile)   
    train_set_x_adver = Set_x_adver[n_test_start:n_test_start+n_test_length]
    train_set_y_adver = Set_y_adver[n_test_start:n_test_start+n_test_length]
